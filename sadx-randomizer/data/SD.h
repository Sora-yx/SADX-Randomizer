...
NJS_OBJECT SD_DZ1 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_01E304AC, 0, 0, 0, 0, 0, 0, 1, 1, 1, NULL, NULL };


 //edited to make them working for everyone. Also need to hardcode them, otherwise it's not working for some reason...

DeathZone SkyDeck1DeathZones[] = { 
	{ CharacterFlags_Sonic | CharacterFlags_Tails| CharacterFlags_Knuckles | CharacterFlags_Amy | CharacterFlags_Gamma | CharacterFlags_Big, &SD_DZ1},
};
...
NJS_OBJECT SD_DZ2 = { NJD_EVAL_UNIT_POS | NJD_EVAL_UNIT_ANG | NJD_EVAL_UNIT_SCL | NJD_EVAL_BREAK, &attach_01E305A4, 0, 0, 0, 0, 0, 0, 1, 1, 1, NULL, NULL };

DeathZone SkyDeck2DeathZones[] = {
	{ CharacterFlags_Sonic | CharacterFlags_Tails | CharacterFlags_Knuckles | CharacterFlags_Amy | CharacterFlags_Gamma | CharacterFlags_Big, &SD_DZ2},

};

DataArray(DeathZone*, SkyDeckDeathZones, 0x223082C, 3); //killplane pointer redirection to the custom list.
