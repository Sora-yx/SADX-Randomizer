...
//Set up 2 arrays, one for the stage list and an other for the characters
//This is to avoid randomizing a stage which is impossible to beat or a character who can crash the game.
